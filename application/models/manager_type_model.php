...
/**
 * Class Manager_Type_Model
 *
 * @method \Entities\Manager_Type get(mixed $match)
 *
 */
class Manager_Type_Model extends MY_Model {

	public function __construct()
	{
		parent::__construct('manager_types', 'Manager_Type');
	}

	/**
	 * @override
	 * @param \Entities\Manager_Type $current_entity
	 * @param bool          $params
	 * @throws Exception
	 */
	public function pre_insert(\Entities\Manager_Type $current_entity, $params = false)
	{
	...
	public function pre_update(\Entities\Manager_Type $current_entity, $params = false)
	{
        $this->_set_fields($current_entity);
	}
	...
	private function _set_fields(\Entities\Manager_Type $current_entity, $params = false)
	{
