...
/**
 * Class Consultant_Type_Model
 *
 * @method \Entities\Consultant_Type get(mixed $match)
 *
 */
class Consultant_Type_Model extends MY_Model {

	public function __construct()
	{
		parent::__construct('consultant_types', 'Consultant_Type');
	}

	/**
	 * @override
	 * @param \Entities\Consultant_Type $current_entity
	 * @param bool          $params
	 * @throws Exception
	 */
	public function pre_insert(\Entities\Consultant_Type $current_entity, $params = false)
	{
	...
	public function pre_update(\Entities\Consultant_Type $current_entity, $params = false)
	{
        $this->_set_fields($current_entity);
	}
	...
	private function _set_fields(\Entities\Consultant_Type $current_entity, $params = false)
	{
