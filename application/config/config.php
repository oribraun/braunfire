...
|
*/
$config['encryption_key'] = 'ajklgrbksdgkjasfdafhoefoiuh3234597wdfjhb2';
...
function ci__autoload($class)
{
	if(strpos($class, 'CI_') === 0) return;
	$path = APPPATH . 'core/'. $class . EXT;
	if(strpos($class, 'CI_') !== 0 && file_exists($path))
	{
		@include_once( $path );
	}
}
spl_autoload_register('ci__autoload');

/* End of file config.php */
/* Location: ./application/config/config.php */

define('SSL_MODE_DISALLOW', 0);
define('SSL_MODE_ALLOW', 1);
