...
<div ng-controller="AdminCtrl">
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <label for="" class="col-sm-2 control-label">סוג מנהל</label>
            <div class="col-sm-6">
                <select class="form-control" ng-model="entity.manager_type_id" ng-options="m.value as m.text for m in manager_type_options">
                    <option value="" ng-show="!entity.manager_type_id">- בחר -</option>
                </select>
            </div>
        </div>
